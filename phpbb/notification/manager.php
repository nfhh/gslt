...
class manager
{
	...
	*/
	public function add_notifications($notification_type_name, $data, array $options = array())
	{
		...
		$notify_users = $this->get_item_type_class($notification_type_name)->find_users_for_notification($data, $options);  // 这里结果有区别
		...
		*/
		...
		$this->add_notifications_for_users($notification_type_name, $data, $notify_users);  // 这里真正写通知表
